...
public class AskLeaveSceneController implements Initializable {
    ...
    @FXML
    private ComboBox<?> askLeaveHowManyWorkingDaysComboBox;
    @FXML
    ...
    @FXML
    private TableView<?> pastLeaveInformationTableView;
    @FXML
    private TableColumn<?, ?> daysTableColumn;
    @FXML
    ...
    @FXML
    private TableColumn<?, ?> commentTableColumn;
    @FXML
    private ComboBox<?> askLeaveReasonComboBox;
